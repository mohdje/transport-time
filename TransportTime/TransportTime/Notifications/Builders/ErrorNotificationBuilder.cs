...
{
    internal class ErrorNotificationBuilder : NotificationBuilder
    {
        public ErrorNotificationBuilder(Context context) : base(context)
        {
        ...
        protected override RemoteViews BuildSmallView(NotificationData data)
        {
            ...
            smallView.SetTextViewText(Resource.Id.notificationInfo, data.ErrorMessage);
